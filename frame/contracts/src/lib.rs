...
decl_module! {
		...
		T::AccountId: AsRef<[u8]>,
	{
		...
		/// * `gas_limit`: The gas limit when executing the constructor.
		...
		/// Instantiates a new contract from the `code_hash` generated by
		/// [`Self::instantiate_with_code`] optionally transferring some balance.
		///
		/// This function is identical to [`Self::instantiate_with_code`] but without the
		/// code deployment step.
		#[weight =
